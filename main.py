...
pytesseract.pytesseract.tesseract_cmd = \
    r'C:\Program Files (x86)\Tesseract-OCR\tesseract'  # need to install tesseract, windows installer: https://digi.bib.uni-mannheim.de/tesseract/tesseract-ocr-setup-3.05.02-20180621.exe
...
if hexColor == '0089ce':
    for num in range(lvls):
        ...
        im1 = pyautogui.screenshot(region=(xSeen - 280, ySeen - 154,
                                   690, 75))
